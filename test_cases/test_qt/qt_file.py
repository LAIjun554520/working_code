...
def qt_wf(ip,dir_name,workspace_uuid,file_name,wf_server_ip):
    ...
    print(file_uuid)
    with open(r"C:\ZY\PycharmProjects\TEST\studio_performance_test\pattern\qt_pattern\flow.json",'r') as load_f:
    ...
    for i in range(2):
        ...
        print(qt_file_uuid)
        with open(r"C:\ZY\PycharmProjects\TEST\studio_performance_test\pattern\qt_pattern\qt_flow.json",'r') as new_load_f:
...
if __name__ == '__main__':
    qt_wf('172.26.5.47','QT_DIR_NEW','59D74F8C78BCA9773D548970464F1E61','flow_QT','172.26.5.47')
    # qt_wf('172.26.0.88')